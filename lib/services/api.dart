...
class Api {
  Future<Response> get(String url, Map body) async {
    ...
    if (kDebugMode) {
      print(
          "GET URL: $baseUrl$url?lang=$localCode&timezone=${dt.timeZoneName}");
    }
    Response response = await http.get(
      Uri.parse('$baseUrl$url?lang=$localCode&timezone=${dt.timeZoneName}'),
      headers: {
  ...
  Future<Response> post(
    ...
    if (kDebugMode) {
      print(
          "POST URL: $baseUrl$url?lang=$localCode&timezone=${dt.timeZoneName}");
  ...
  Future<Response> put(
    ...
    if (kDebugMode) {
      print(
          "PUT URL: $baseUrl$url?lang=$localCode&timezone=${dt.timeZoneName}");
    }
  ...
  Future<Response> delete(
    ...
    if (kDebugMode) {
      print(
          "DELETE URL: $baseUrl$url?lang=$localCode&timezone=${dt.timeZoneName}");
    }
